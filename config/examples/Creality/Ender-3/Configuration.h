...
// #define SHOW_BOOTSCREEN - SAK CHANGE disabling LCD

// Show the bitmap in Marlin/_Bootscreen.h on startup.
// #define SHOW_CUSTOM_BOOTSCREEN - SAK CHANGE disabling LCD

// Show the bitmap in Marlin/_Statusscreen.h on the status screen.
// #define CUSTOM_STATUS_SCREEN_IMAGE - SAK CHANGE disabling LCD
 ...
 */
#define JUNCTION_DEVIATION // SAK Change - enable
#if ENABLED(JUNCTION_DEVIATION)
  #define JUNCTION_DEVIATION_MM 0.07  // (mm) Distance from real junction edge - SAK change enable and set to 0.07 (tuned for ender-3)
#endif
 ...
 */
#define S_CURVE_ACCELERATION // SAK change - enable
...
//
// #define CR10_STOCKDISPLAY  - SAK CHANGE disabling LCD
